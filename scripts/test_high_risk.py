...
r = httpx.post("http://localhost:8000/predict/waste-risk", headers=h, json={
    "store_id": 2, "product_id": 3, "date": "2024-10-15",
    "current_stock": 80, "days_until_expiry": 1,
})
print("WASTE RISK:", r.json())

print()
r = httpx.post("http://localhost:8000/recommend", headers=h, json={
    "store_id": 2, "product_id": 3, "date": "2024-10-15",
})
d = r.json()
